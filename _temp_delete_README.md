...
1. **Performance Auditing:** explain changed reported performance and review
   suspicious source-data relationships.
2. **Performance Analytics:** produce attribution, contribution, and Ex-Post Risk
   reports.
...
performance change?" It answers this by:

1. Determining the differences in reported performance for each time period,
   portfolio, or security.
2. Quantitatively attributing those performance differences to changes in the
...
audit issues, residual review status, and source detail. For example, the
`Data Audit Issues` sheet flags source-data relationships that deserve review:

<img
  src="docs/images/readme/DataAuditIssues.jpg"
  alt="Data Audit Issues report sheet"
  width="100%"
/>
...
full demo before replacing the demo data with your own exports.
...
Performance Analytics uses portfolio performance and security performance
exports.
...
Performance Analytics writes browser-ready attribution and Ex-Post Risk reports
and chart images:
...
The Python API can also return Analytics result tables as CSV, Pandas, Polars,
JSON, and XML.
