...
def fixed_income_transaction_boundary(code: object) -> str:
    ...
    Returns:
        ``"safe_income"`` for ordinary interest rows, ``"backlog"`` for
        accrued-interest/principal-paydown rows that need more evidence, and
        ``"not_fixed_income_boundary"`` otherwise.
    """
