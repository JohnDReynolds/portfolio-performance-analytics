...
structure, then changes selected holding price values, `CASH_USD` holdings,
other holdings, transactions, accrued income, and security performance rows so
the workbook can show fully explained, partly explained, and unexplained
