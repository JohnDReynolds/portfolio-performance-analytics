...
FX_RATES_REQUIRED_ALIASES = _exact_aliases(pc_cols.FX_RATES_REQUIRED_COLUMNS)
FX_RATES_OPTIONAL_ALIASES = _exact_aliases(pc_cols.FX_RATES_OPTIONAL_COLUMNS)
...
SECURITY_REFERENCE_REQUIRED_ALIASES = _exact_aliases(
    pc_cols.SECURITY_REFERENCE_REQUIRED_COLUMNS
)
SECURITY_REFERENCE_OPTIONAL_ALIASES = _exact_aliases(
    pc_cols.SECURITY_REFERENCE_OPTIONAL_COLUMNS
)
