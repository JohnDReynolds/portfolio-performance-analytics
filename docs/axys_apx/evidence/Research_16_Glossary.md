...
| Market Value | Valuation amount; fixed-income appraisal evidence strongly implies clean market value separate from accrued interest. | Report examples support label; exact storage formula Unknown. | Report examples support label; exact storage formula Unknown. | Unknown. | Reports. | High as report concept; storage Unknown | Do not assume market value already includes accrued interest. |
| Accrued Interest | Interest earned but not yet paid on fixed income; appraisal evidence shows it separately from market value. | Axys fixed-income context and report evidence support concept; exact fields Unknown. | APX Portfolio Appraisal evidence supports separate report concept; exact fields Unknown. | Unknown. | Reports. | High as separate report concept; native field Unknown | Preserve separately for fixed-income performance reconstruction. |
...
| Market Value | Valuation amount; fixed-income appraisal evidence strongly implies clean market value separate from accrued interest. | Report context. | Report context. | Unknown. | Reports. | High as report concept; storage Unknown | Verify holdings/performance extracts before treating as dirty value. |
...
| Accrued Interest | Fixed income accrued interest shown separately from market value in appraisal evidence. | Axys fixed income context supports concept; field Unknown. | APX appraisal report concept; field Unknown. | Unknown. | Reports. | High as separate report concept; native field Unknown | Verify fixed income reports/exports. |
