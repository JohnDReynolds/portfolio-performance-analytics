...
The following APX report names are supported by the supplied `../evidence/Research_14_Reports.md` and APX architecture/report research. These are report names or guide-visible names; they are not database table names.
