...
Pricing is a core dependency for portfolio accounting, holdings valuation, reconciliation, performance measurement, and reporting. In Axys/APX environments, pricing evidence appears most clearly in integration workflows, price-file import/export behavior, holdings valuation reports, and operational pricing exceptions.
...
### 6.4 CI Price Workflow and Live Discovery

The available IMEX evidence strengthens the CI-observed price workflow but
keeps native price schemas Unknown.
