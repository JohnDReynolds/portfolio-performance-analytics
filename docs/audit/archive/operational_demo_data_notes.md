...
```bash
./.venv/bin/python scripts/operational_demo_data/derive_axys_apx_analytics_demo_data.py
```

It writes:

```text
ppar/setup_templates/axys_apx_analytics/portperf.csv
ppar/setup_templates/axys_apx_analytics/secperf.csv
```
...
- `axys_apx_performance_comparison.yaml`.
...
promoted into `ppar/setup_templates/axys_apx_performance_comparison/snapshot_a/` and
`ppar/setup_templates/axys_apx_performance_comparison/snapshot_b/`, where the user-facing portfolio and
...
`scripts/operational_demo_data/audit_holding_scenarios.csv` for
