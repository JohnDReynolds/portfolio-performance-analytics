...
This document owns forward-looking direction for the PPAR Audit product. The
[Product Constitution](product_constitution.md) owns stable product identity,
principles, boundaries, claims, and founder decisions. The
[MVP Completion Plan](mvp_plan.md) owns the detailed implementation sequence,
acceptance criteria, and slice status for the active phase.
...
## Stage 2 — Validation Partners

**Priority:** highest after MVP completion.
...
## Stage 3 — Repeatable Axys/APX Product
...
Update this document when Audit stages, evidence gates, active priorities,
deferred directions, or material product questions change. Keep stable product
doctrine and founder decisions in the constitution. Keep implementation detail,
acceptance criteria, and slice status in the active MVP plan.

When the MVP completion gate closes, replace or archive the MVP plan and update
the active phase here. Do not turn this roadmap into a cumulative implementation
journal.
