...
- reads `ppar/demos/data/generic_analytics/performance/Mega-Cap Alpha Portfolio.csv`;
...
```text
ppar/demos/data/axysapx_analytics/portperf.csv
ppar/demos/data/axysapx_analytics/secperf.csv
```
...
promoted into `ppar/demos/data/axysapx_performance_comparison/snapshot_a/` and
`ppar/demos/data/axysapx_performance_comparison/snapshot_b/`, where the user-facing portfolio and
