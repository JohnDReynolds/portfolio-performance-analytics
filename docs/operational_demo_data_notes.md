...
```text
ppar/demos/data/axys_analytics/portperf.csv
ppar/demos/data/axys_analytics/secperf.csv
```

The configuration file is:

```text
ppar/demos/data/axys_analytics/axys_analytics.yaml
```
...
promoted into `ppar/demos/data/axys_performance_comparison/snapshot_a/` and
`ppar/demos/data/axys_performance_comparison/snapshot_b/`, where the user-facing portfolio and
