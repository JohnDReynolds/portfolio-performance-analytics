# Research Notes for `docs/12-IMEX.md`

**Repository:** AXYS / APX Reference Repository  
**Research file:** `research/12-IMEX_research.md`  
**Prepared:** 2026-06-29  
...
The following should remain explicitly marked **Unknown** in `docs/12-IMEX.md` until better evidence is obtained.
...
Suggested search terms for existing templates/logs in Axys folders:
