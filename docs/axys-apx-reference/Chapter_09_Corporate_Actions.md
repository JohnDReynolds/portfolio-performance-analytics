...
|---|---|
| `Research_04_Security_Master.md` | `sec.inf`, `type.inf`, security matching, symbol/type caution, security-master dependencies. |
| `Research_05_Transactions.md` | Transaction context, observed transaction-code caution, Trade Blotter, `topost.trn`, `didpost.aud`, reinvestment conversion, code-only interpretation warning. |
| `Research_06_Holdings.md` | Holdings dependency and APX holdings-to-external-workflow context. |
| `Research_08_Pricing.md` | `.pri`, price dependency, split/price audit considerations, price-file caution. |
| `Research_12_IMEX.md` | IMEX unknowns, Axys file/folder artifacts, import/export/log cautions, APX IMEX/log context. |
| `Research_13_REP.md` | REP/Replang/reporting unknowns and report extraction cautions. |
