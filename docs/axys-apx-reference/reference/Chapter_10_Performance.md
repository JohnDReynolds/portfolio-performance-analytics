...
| `../evidence/Research_05_Transactions.md` | Transaction dependencies, performance restatement risk, transaction correction implications. |
| `../evidence/Research_06_Holdings.md` | Holdings/report valuation dependencies. |
| `../evidence/Research_07_Cash.md` | Cash, cash-flow, and performance/cash treatment unknowns. |
| `../evidence/Research_08_Pricing.md` | Price files, stale/missing/calculated prices, price restatement implications. |
