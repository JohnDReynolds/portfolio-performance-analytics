...
| `Research_07_Cash.md` | Primary source for this chapter. |
| `Research_05_Transactions.md` | Supporting transaction-code, source/destination field, and reversal/cancellation context. |
| `Research_06_Holdings.md` | Supporting holdings/cash-as-position context and extraction caveats. |
| `Research_08_Pricing.md` | Supporting price/cash-equivalent valuation context. |
| `Research_12_IMEX.md` | Supporting IMEX/interface cautions and file/log context. |
| `Research_13_REP.md` | Supporting REP/reporting cautions. |
