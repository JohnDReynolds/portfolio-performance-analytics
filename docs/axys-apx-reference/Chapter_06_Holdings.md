...
2. `Research_06_Holdings.md`. Primary research source for this chapter.
3. `Research_04_Security_Master.md`. Used only for security-master context where holdings depend on security identity/type.
4. `Research_05_Transactions.md`. Used only for transaction-to-holdings dependency context.
5. `Research_12_IMEX.md`. Used only for IMEX/interface context and file/artifact separation.
6. `Research_13_REP.md`. Used only for REP/report-layer terminology and report caution.
