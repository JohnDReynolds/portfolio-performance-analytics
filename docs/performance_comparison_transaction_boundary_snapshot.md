...
| Family | Codes | Boundary |
| --- | --- | --- |
| Fixed-income backlog | `ai`, `pd` | Needs margin or bond/principal context, cash offset, amount sign, principal or quantity movement where applicable, and local mapping or REP/report semantics. |
