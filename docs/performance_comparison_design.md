...
a server. The default HTML presentation should stay short at the top: At A
Glance first, dashboard second, concise portfolio-period narrative third, and
detailed tables inside a Supporting Detail disclosure area.
